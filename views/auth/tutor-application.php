        ...
        <div class="card">
            ...
            <form method="post" action="<?= e(app_url('postular-tutor.php')) ?>">
                ...
                <div class="form-grid">
                    ...
                    <div><label for="telefono">Telefono</label><input id="telefono" name="telefono" type="tel" inputmode="numeric" pattern="[0-9]{7,20}" maxlength="20" value="<?= e($data['telefono']) ?>"></div>
                    ...
                    <div><label for="contrasena">Contrasena</label><input id="contrasena" name="contrasena" type="password" minlength="6" required data-password-field></div>
                    <div><label for="confirmacion">Confirmar contrasena</label><input id="confirmacion" name="confirmacion" type="password" minlength="6" required data-password-confirmation></div>
                    <div class="form-full"><label for="biografia">Biografia profesional</label><textarea id="biografia" name="biografia" rows="5" maxlength="2000"><?= e($data['biografia']) ?></textarea></div>
                </div>
