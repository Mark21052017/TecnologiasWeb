...
<main class="auth-container auth-register-container">
    ...
    <section class="auth-form-panel auth-register-panel">
        <div class="card">
            ...
            <h2>Crear cuenta</h2>
            <p>Los campos academicos se guardan junto con tu perfil.</p>
            ...
            <form method="post" action="<?= e(app_url('register.php')) ?>">
                ...
                <div class="form-grid">
                    ...
                    <div><label for="telefono">Telefono</label><input id="telefono" name="telefono" type="tel" inputmode="numeric" pattern="[0-9]{7,20}" maxlength="20" title="Ingrese entre 7 y 20 numeros." value="<?= e($data['telefono']) ?>"></div>
                    <div><label for="usuario">Usuario</label><input id="usuario" name="usuario" type="text" minlength="4" maxlength="50" pattern="[A-Za-z0-9._-]{4,50}" title="Use entre 4 y 50 caracteres: letras, numeros, punto, guion o guion bajo." required autocomplete="username" value="<?= e($data['usuario']) ?>"></div>
                    ...
                    <div><label for="registro_universitario">Registro universitario</label><input id="registro_universitario" name="registro_universitario" type="text" maxlength="30" pattern="[A-Za-z0-9-]{1,30}" title="Use solo letras, numeros y guiones." value="<?= e($data['registro_universitario']) ?>"></div>
                    <div><label for="contrasena">Contrasena</label><input id="contrasena" name="contrasena" type="password" minlength="6" required autocomplete="new-password" data-password-field></div>
                    <div><label for="confirmacion">Confirmar contrasena</label><input id="confirmacion" name="confirmacion" type="password" minlength="6" required autocomplete="new-password" data-password-confirmation></div>
                </div>
